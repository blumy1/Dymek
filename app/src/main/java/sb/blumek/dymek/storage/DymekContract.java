    ...
    static class TemperatureCacheSchema implements BaseColumns {
        ...
        static final String SQL_CREATE_ENTRY =
                "CREATE TABLE " + TemperatureCacheSchema.TABLE_NAME + " (" +
                        TemperatureCacheSchema._ID + " INTEGER PRIMARY KEY," +
                        TemperatureCacheSchema.COLUMN_NAME_TEMP_1_NAME + " TEXT," +
                        TemperatureCacheSchema.COLUMN_NAME_TEMP_1_MIN_VAL + " REAL," +
                        TemperatureCacheSchema.COLUMN_NAME_TEMP_1_MAX_VAL + " REAL," +
                        TemperatureCacheSchema.COLUMN_NAME_TEMP_2_NAME + " TEXT," +
                        TemperatureCacheSchema.COLUMN_NAME_TEMP_2_MIN_VAL + " REAL," +
                        TemperatureCacheSchema.COLUMN_NAME_TEMP_2_MAX_VAL + " REAL); ";
